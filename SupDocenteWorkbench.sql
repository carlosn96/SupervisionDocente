...
--
-- Host: 127.0.0.1    Database: supervision_docente
-- ------------------------------------------------------
...
INSERT INTO `carrera` VALUES (35,'Derecho','Lic.'),(36,'Contaduría Pública','Lic.'),(38,'Cultura Física y Deportes','Lic.'),(39,'Civil','Ing.'),(40,'Filosofía','Lic.'),(41,'Criminalística','Lic.'),(52,'Abogado','Lic.'),(53,'Psicología','Lic.'),(56,'Computación','Ing.'),(57,'Comunicaciones y Electrónica','Ing.'),(58,'Ciencias de la Comunicación','Lic.'),(59,'Diseño Gráfico','Lic.'),(60,'Administración','Lic.'),(62,'Industrial','Ing.'),(65,'Química','Lic.'),(66,'Químico Farmacéutico Biólogo','Lic.');
/*!40000 ALTER TABLE `carrera` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `carrera_coordinador`
--
...
CREATE TABLE `carrera_coordinador` (
  ...
  PRIMARY KEY (`id_carrera`,`id_coordinador`),
  KEY `carrera_coordinador_ibfk_2` (`id_coordinador`),
  CONSTRAINT `carrera_coordinador_ibfk_1` FOREIGN KEY (`id_carrera`) REFERENCES `carrera` (`id_carrera`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `carrera_coordinador_ibfk_2` FOREIGN KEY (`id_coordinador`) REFERENCES `coordinador` (`id_coordinador`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `carrera_coordinador`
--

LOCK TABLES `carrera_coordinador` WRITE;
/*!40000 ALTER TABLE `carrera_coordinador` DISABLE KEYS */;
INSERT INTO `carrera_coordinador` VALUES (56,27),(57,27),(65,31),(66,31);
/*!40000 ALTER TABLE `carrera_coordinador` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `carrera_plantel`
--
...
CREATE TABLE `carrera_plantel` (
  ...
  PRIMARY KEY (`id_carrera`,`id_plantel`),
  UNIQUE KEY `unique_index` (`id_carrera`,`id_plantel`),
  KEY `carrera_plantel_ibfk_2` (`id_plantel`),
  CONSTRAINT `carrera_plantel_ibfk_1` FOREIGN KEY (`id_carrera`) REFERENCES `carrera` (`id_carrera`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `carrera_plantel_ibfk_2` FOREIGN KEY (`id_plantel`) REFERENCES `plantel` (`id_plantel`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `carrera_plantel`
--

LOCK TABLES `carrera_plantel` WRITE;
/*!40000 ALTER TABLE `carrera_plantel` DISABLE KEYS */;
INSERT INTO `carrera_plantel` VALUES (35,11),(35,14),(35,16),(35,17),(36,13),(36,14),(38,13),(38,15),(38,17),(39,13),(39,14),(39,15),(40,11),(40,13),(40,15),(40,16),(40,17),(41,12),(41,13),(41,16),(41,17),(52,11),(52,13),(52,14),(52,16),(52,17),(53,12),(53,13),(53,14),(53,17),(56,11),(57,11),(57,14),(57,15),(57,16),(58,11),(58,14),(59,11),(60,11),(60,12),(60,15),(60,16),(62,11),(62,14),(65,15),(65,16),(65,20),(66,14),(66,15),(66,16),(66,20),(66,22),(66,23);
/*!40000 ALTER TABLE `carrera_plantel` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `config_usuario` VALUES (4,60,NULL,NULL,11,56),(7,64,NULL,NULL,20,65);
/*!40000 ALTER TABLE `config_usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `consultar_detalles_supervision_realizada`
--

DROP TABLE IF EXISTS `consultar_detalles_supervision_realizada`;
/*!50001 DROP VIEW IF EXISTS `consultar_detalles_supervision_realizada`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `consultar_detalles_supervision_realizada` AS SELECT 
 1 AS `id_supervision`,
 1 AS `id_agenda`,
 1 AS `id_horario`,
 1 AS `fecha`,
 1 AS `tipo_criterio`,
 1 AS `id_rubro`,
 1 AS `rubro_descripcion`,
 1 AS `id_criterio`,
 1 AS `criterio_descripcion`,
 1 AS `criterio_cumplido`,
 1 AS `comentario`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `consultar_supervision`
--

DROP TABLE IF EXISTS `consultar_supervision`;
/*!50001 DROP VIEW IF EXISTS `consultar_supervision`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `consultar_supervision` AS SELECT 
 1 AS `id_supervision`,
 1 AS `fecha_supervision`,
 1 AS `tema`,
 1 AS `conclusion_general`,
 1 AS `id_agenda`,
 1 AS `fecha_agenda`,
 1 AS `supervision_hecha`,
 1 AS `id_horario`,
 1 AS `dia_semana`,
 1 AS `hora_inicio`,
 1 AS `hora_fin`,
...
CREATE TABLE `coordinador` (
  ...
  KEY `coordinador_usuario_fk_idx` (`id_usuario`),
  CONSTRAINT `coordinador_usuario_fk` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `coordinador` VALUES (27,60,NULL),(31,64,NULL);
/*!40000 ALTER TABLE `coordinador` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `coordinador_usuario`
--

DROP TABLE IF EXISTS `coordinador_usuario`;
/*!50001 DROP VIEW IF EXISTS `coordinador_usuario`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `coordinador_usuario` AS SELECT 
 1 AS `id_usuario`,
 1 AS `id_coordinador`,
 1 AS `nombre`,
 1 AS `apellidos`,
...
CREATE TABLE `docente` (
  ...
  UNIQUE KEY `id_coordinador_UNIQUE` (`nombre`,`apellidos`,`id_coordinador`),
  KEY `id_coordinador` (`id_coordinador`),
  CONSTRAINT `docente_ibfk_1` FOREIGN KEY (`id_coordinador`) REFERENCES `coordinador` (`id_coordinador`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `docente` VALUES (63,'José Ivan','Reyes Jimenez','jose.reyes@universidad-une.com','Ing. Sistemas Computacionales',27),(64,'Clara','Bernal López','clara.bernal@universidad-une.com','Lic. Administración de Empresas',27),(75,'Marie','Curie','marie.curie@universidad-une.com','Dr. Física',31),(76,'Dimitri','Mendeléyev','dimitri.mendeleyev@universidad-une.com','Dr. Ciencias',31),(77,'Linus','Pauling','linus.pauling@universidad-une.com','Dr. Química',31),(78,'Josué','Larios García','josue.larios@universidad-une.com','Ing. Electrónica',27),(83,'Susana','Huerta Varela','susana.huerta@universidad-une.com','Lic. Matemáticas',27),(84,'José Alfredo','Mercado Aguirre','alfredo.mercado@universidad-une.com','Ing. Computación',27),(85,'Juan Antonio','Martínez Carbajal','juanantonio.martinez@universidad-une.com','Ing. Computación',27),(86,'Damián','Castellanos Flores','damian.castellanos@universidad-une.com','Lic. Matemáticas',27),(87,'Jorge Abraham','Ponce Aguayo','jorgeabraham.ponce@universidad-une.com','Ing. Mecatrónica',27),(88,'Citlalli Anahí','Salcedo Navarro','citlalli.salcedo@universidad-une.com','Lic. Administración',27),(89,'Samuel','Díaz Amézquita','samuel.diaz@universidad-une.com','Lic. Diseño Industrial',27),(90,'María Dolores','García Yerena','mariadolores.garcia@universidad-une.com','Lic.',27),(91,'Salvador','Magaña Sánchez','salvador.magana@universidad-une.com','Mtro. Computación',27),(92,'Jonathan Rogelio','Salas Gámez','jonathan.salas@universidad-une.com','Mtro. Computación',27),(94,'Silvia Jazmin','Castellanos Ornelas','silvia.castellanos@universidad-une.com','Ing. Computación',27);
/*!40000 ALTER TABLE `docente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `lista_carreras_sin_coordinador`
--

DROP TABLE IF EXISTS `lista_carreras_sin_coordinador`;
/*!50001 DROP VIEW IF EXISTS `lista_carreras_sin_coordinador`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `lista_carreras_sin_coordinador` AS SELECT 
 1 AS `id_carrera`,
 1 AS `nombre`,
 1 AS `tipo`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `listar_agenda_supervision`
--

DROP TABLE IF EXISTS `listar_agenda_supervision`;
/*!50001 DROP VIEW IF EXISTS `listar_agenda_supervision`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `listar_agenda_supervision` AS SELECT 
 1 AS `id_coordinador`,
 1 AS `id_agenda`,
 1 AS `nombre_docente`,
 1 AS `fecha`,
...
--
-- Temporary view structure for view `listar_carrera_detalles`
--

DROP TABLE IF EXISTS `listar_carrera_detalles`;
/*!50001 DROP VIEW IF EXISTS `listar_carrera_detalles`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `listar_carrera_detalles` AS SELECT 
 1 AS `id_carrera`,
 1 AS `tipo`,
 1 AS `nombre`,
 1 AS `coordinador_nombre`,
 1 AS `coordinador_correo`,
 1 AS `id_coordinador`,
 1 AS `id_usuario_coordinador`,
 1 AS `planteles`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `listar_criterios_supervision_por_rubro`
--

DROP TABLE IF EXISTS `listar_criterios_supervision_por_rubro`;
/*!50001 DROP VIEW IF EXISTS `listar_criterios_supervision_por_rubro`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `listar_criterios_supervision_por_rubro` AS SELECT 
 1 AS `id_rubro`,
 1 AS `rubro_descripcion`,
 1 AS `id_criterio`,
 1 AS `descripcion_criterio`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `listar_criterios_supervision_por_rubro_no_contable`
--

DROP TABLE IF EXISTS `listar_criterios_supervision_por_rubro_no_contable`;
/*!50001 DROP VIEW IF EXISTS `listar_criterios_supervision_por_rubro_no_contable`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `listar_criterios_supervision_por_rubro_no_contable` AS SELECT 
 1 AS `id_rubro`,
 1 AS `rubro_descripcion`,
 1 AS `id_criterio`,
 1 AS `descripcion_criterio`*/;
...
--
-- Temporary view structure for view `listar_docente_materias_horarios`
--

DROP TABLE IF EXISTS `listar_docente_materias_horarios`;
/*!50001 DROP VIEW IF EXISTS `listar_docente_materias_horarios`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `listar_docente_materias_horarios` AS SELECT 
 1 AS `id_coordinador`,
 1 AS `es_profesor_agendado`,
 1 AS `id_agenda`,
 1 AS `supervision_hecha`,
 1 AS `id_docente`,
 1 AS `nombre_docente`,
...
CREATE TABLE `materia` (
  ...
  KEY `fk_id_docente_idx` (`id_docente`),
  KEY `fk_id_carrera_idx` (`id_carrera`),
  KEY `fk_id_plantel_materia_idx` (`id_plantel`),
  CONSTRAINT `fk_id_carrera` FOREIGN KEY (`id_carrera`) REFERENCES `carrera` (`id_carrera`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_id_docente_materia` FOREIGN KEY (`id_docente`) REFERENCES `docente` (`id_docente`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_id_plantel_materia` FOREIGN KEY (`id_plantel`) REFERENCES `plantel` (`id_plantel`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `materia` VALUES (35,'Radio, Microondas y Satélites','',63,57,15),(36,'Dispositivos Lógicos Programables','',63,57,15),(37,'Ingeniería Económica','',64,57,15),(50,'Física Nuclear','',75,65,15),(51,'Química Inorgánica','',75,65,15),(52,'Radiología Médica','',75,65,15),(53,'Química General','',76,65,15),(54,'Historia de la Química','',76,65,15),(55,'Química Cuántica','',77,65,20),(56,'Biología Molecular','',77,65,20),(57,'Sistemas Operativos en Tiempo Real','',78,57,15),(65,'Ecuaciones Diferenciales','3° ICOM',83,56,11),(66,'Programación Orientada a Objetos','3° ICOM',84,56,11),(67,'Bases de Datos','5° ICOM',84,56,11),(68,'Redes de Computadoras','5° ICOM',84,56,11),(69,'Sistemas Digitales','3° ICOM',85,56,11),(70,'Simulación por Computadora','7° INCO',85,56,11),(71,'Álgebra Lineal','3° ICOM',86,56,11),(72,'Circuitos Electrónicos y Electromagnetismo','3° ICOM',87,56,11),(73,'Administración','3° ICOM',88,56,11),(74,'Seminario de Integración: Protocolo','5° ICOM',89,56,11),(75,'Formación Integral: Taller de Oratoria','5° ICOM',90,56,11),(76,'Análisis de Algoritmos','5° ICOM',91,56,11),(77,'Programación WEB','6° INCO',91,56,11),(78,'Sistemas Operativos 22B','5° ICOM',92,56,11),(79,'Sistemas Operativos 17B','6° INCO',92,56,11),(80,'Seminario de Solución de Problemas de Sistemas Operativos','6° INCO',92,56,11),(81,'Programación Dispositivos Móviles','7° INCO',92,56,11),(83,'Fundamentos de Inteligencia Artificial','5° ICOM',94,56,11),(84,'Traductores de Lenguajes II','6° INCO',94,56,11),(85,'Seminario de Solución de Problemas de Traductores de Lenguajes II','6° INCO',94,56,11),(86,'Inteligencia Artificial I','7° INCO',94,56,11),(87,'Seminario de Solución de Problemas de Inteligencia Artificial I','7° INCO',94,56,11),(88,'Desarrollo del Prototipo del Proyecto del Módulo II','6° INCO',94,56,11),(89,'Estado del Arte del Proyecto del Módulo III','6° INCO',94,56,11),(90,'Computación Tolerante a Fallas','6° INCO',84,56,11),(91,'Sistemas Operativos de Red','7° INCO',84,56,11),(92,'Seminario de Solución de Problemas de Sistemas Operativos de Red','7° INCO',84,56,11),(93,'Documentación y Defensa del Proyecto del Módulo II','7° INCO',92,56,11),(94,'Desarrollo del Prototipo del Proyecto del Módulo III','7° INCO',92,56,11);
/*!40000 ALTER TABLE `materia` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `materia_horarios`
--
...
CREATE TABLE `materia_horarios` (
  ...
  KEY `materia_horarios_ibfk_1` (`id_materia`),
  CONSTRAINT `materia_horarios_ibfk_1` FOREIGN KEY (`id_materia`) REFERENCES `materia` (`id_materia`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=183 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `materia_horarios`
--

LOCK TABLES `materia_horarios` WRITE;
/*!40000 ALTER TABLE `materia_horarios` DISABLE KEYS */;
INSERT INTO `materia_horarios` VALUES (61,35,'Lunes','14:00:00','15:00:00'),(62,35,'Miércoles','07:00:00','10:00:00'),(63,36,'Martes','08:00:00','11:00:00'),(64,37,'Lunes','11:00:00','14:00:00'),(65,37,'Martes','11:00:00','12:00:00'),(82,50,'Lunes','07:00:00','09:00:00'),(83,50,'Miércoles','07:00:00','09:00:00'),(84,51,'Martes','15:00:00','17:00:00'),(85,51,'Miércoles','15:00:00','16:00:00'),(86,52,'Lunes','19:00:00','21:00:00'),(87,52,'Martes','18:00:00','20:00:00'),(88,53,'Lunes','16:00:00','19:00:00'),(89,53,'Viernes','18:00:00','20:00:00'),(90,54,'Miércoles','17:00:00','18:00:00'),(91,54,'Viernes','20:00:00','21:00:00'),(92,55,'Lunes','14:00:00','16:00:00'),(93,55,'Miércoles','15:30:00','17:30:00'),(94,56,
ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `plantel` VALUES (11,'CENTRO'),(14,'MILENIO'),(17,'PLAZA DEL SOL'),(12,'PUERTO VALLARTA'),(23,'TEPATITLÁN'),(16,'TESISTÁN'),(15,'TLAJOMULCO'),(13,'TORRE QUETZAL'),(20,'VALLARTA'),(22,'ZAPOPAN');
/*!40000 ALTER TABLE `plantel` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `supervision_agenda`
--
...
CREATE TABLE `supervision_agenda` (
  ...
  KEY `fk_agenda_materia_idx` (`id_horario`),
  CONSTRAINT `fk_agenda_materia` FOREIGN KEY (`id_horario`) REFERENCES `materia_horarios` (`id_horario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `supervision_agenda`
--

LOCK TABLES `supervision_agenda` WRITE;
/*!40000 ALTER TABLE `supervision_agenda` DISABLE KEYS */;
INSERT INTO `supervision_agenda` VALUES (77,87,'2024-06-25',1),(78,90,'2024-06-26',1),(83,93,'2024-06-26',1),(84,61,'2024-07-01',0),(85,64,'2024-07-01',0),(88,96,'2024-07-05',0),(112,82,'2024-08-26',0),(114,116,'2024-08-27',0),(118,125,'2024-08-26',0),(119,130,'2024-08-28',0),(120,182,'2024-08-27',0),(121,132,'2024-08-27',1),(123,135,'2024-08-29',0),(124,137,'2024-08-26',0),(125,143,'2024-08-28',0),(126,152,'2024-08-29',0),(128,169,'2024-08-30',0),(129,139,'2024-09-02',0);
/*!40000 ALTER TABLE `supervision_agenda` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `supervision_criterio`
--
...
CREATE TABLE `supervision_criterio` (
  ...
  KEY `fk_id_rubro_criterio_idx` (`id_rubro`),
  CONSTRAINT `fk_id_rubro_criterio` FOREIGN KEY (`id_rubro`) REFERENCES `supervision_rubro` (`id_rubro`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=125 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `supervision_criterio`
--

LOCK TABLES `supervision_criterio` WRITE;
/*!40000 ALTER TABLE `supervision_criterio` DISABLE KEYS */;
INSERT INTO `supervision_criterio` VALUES (93,251,'Registro de asistencia'),(94,251,'Se realiza evaluación diagnóstica'),(95,251,'Se indica el tema'),(96,251,'Se promueve el interés por el tema a tratar'),(97,251,'Exposición de objetivos'),(98,251,'Se retoman los contenidos de sesiones anteriores'),(99,252,'Vigila el cumplimiento de la normatividad en las instalaciones de trabajo'),(100,252,'Dominio del tema'),(102,252,'Atención y concentración del grupo\n'),(103,252,'Fomento de reflexión y argumentación'),(104,252,'Lenguaje entendible, se aclaran los tecnicismos'),(105,252,'Promoción de actividades relacionadas con la vida cotidiana'),(106,252,'Empleo de estrategias didácticas (incluye tareas)'),(107,252,'Claridad en las instrucciones'),(108,252,'Supervisión de los problemas planteados'),(109,252,'Genera ambiente propicio para la enseñanza y el aprendizaje'),(110,253,'Evaluación del aprendizaje obtenido'),(111,253,'Claridad en la conclusión de la clase'),(112,254,'Puntualidad'),(113,254,'Código de vestimenta'),(114,254,'Entregó la planeación'),(115,254,'Cumple con el avance de temas de acuerdo a la planeación'),(116,254,'El tema presentado está dentro de la planeación'),(117,254,'Mantiene actualizado el avance programático'),(118,254,'Existe evidencia de que se enteró a los alumnos del encuadre'),(119,254,'Se promueve la participación activa del grupo'),(120,254,'Se promueve un ambiente de respeto entre los alumnos'),(121,254,'Se promueven valores, mensajes positivos y estimulantes'),(122,254,'Se retroalimenta y aclaran dudas'),(123,254,'Mantiene la disciplina y limpieza en el aula'),(124,254,'Administración del tiempo');
/*!40000 ALTER TABLE `supervision_criterio` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `supervision_criterio_no_contable`
--
...
CREATE TABLE `supervision_criterio_no_contable` (
  ...
  PRIMARY KEY (`id_criterio`),
  KEY `fk_id_rubro_no_contable_idx` (`id_rubro`),
  CONSTRAINT `fk_id_rubro_no_contable` FOREIGN KEY (`id_rubro`) REFERENCES `supervision_rubro_no_contable` (`id_rubro`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `supervision_criterio_no_contable`
--

LOCK TABLES `supervision_criterio_no_contable` WRITE;
/*!40000 ALTER TABLE `supervision_criterio_no_contable` DISABLE KEYS */;
INSERT INTO `supervision_criterio_no_contable` VALUES (1,1,'Método expositivo (Lección magistral)'),(2,1,'Aprendizaje basado en problemas'),(3,1,'Estudio de caso'),(4,1,'Aprendizaje colaborativo'),(5,1,'Aprendizaje orientado a proyectos'),(6,2,'Memorístico'),(7,2,'Significativo'),(8,2,'Receptivo'),(9,2,'Por descubrimiento'),(10,3,'Trabajo en equipo'),(11,3,'Trabajo individual'),(12,4,'Cómic'),(13,4,'Collage'),(14,4,'Debate'),(15,4,'Tríptico'),(16,4,'Ensayo'),(17,4,'Historieta'),(18,4,'Resumen'),(19,4,'Seminario'),(20,4,'Paráfrasis'),(21,4,'Investigación'),(22,4,'Mapa mental'),(23,4,'Mesa redonda'),(24,4,'Lluvia de ideas'),(25,4,'Análisis de caso'),(26,4,'Dinámica grupal'),(27,4,'Cuadro sinóptico'),(28,4,'Ficha descriptiva'),(29,4,'Mapa conceptual'),(30,4,'Pregunta generadora'),(31,4,'Cuadro de doble entrada'),(32,4,'Resolución de ejercicios y problemas');
/*!40000 ALTER TABLE `supervision_criterio_no_contable` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `supervision_realizada`
--
...
CREATE TABLE `supervision_realizada` (
  ...
  KEY `fk_id_agenda_idx` (`id_agenda`),
  CONSTRAINT `fk_id_agenda` FOREIGN KEY (`id_agenda`) REFERENCES `supervision_agenda` (`id_agenda`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `supervision_realizada`
--

LOCK TABLES `supervision_realizada` WRITE;
/*!40000 ALTER TABLE `supervision_realizada` DISABLE KEYS */;
INSERT INTO `supervision_realizada` VALUES (40,77,'2024-06-21 15:16:35','Introducción a la Radioactividad','La profesora muestra un dominio excelente del tema tratado. Demuestra una notable competencia y excelencia en la enseñanza. Se sugiere aclarar de mejor manera los tecnicismos utilizados en clase.'),(41,78,'2024-06-21 20:46:43','No indicado',''),(42,83,'2024-06-21 20:58:03','No indicado',''),(45,121,'2024-08-22 15:01:01','No indicado','');
/*!40000 ALTER TABLE `supervision_realizada` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER actualizar_supervision_agenda

AFTER DELETE ON supervision_realizada
...
--
-- Table structure for table `supervision_realizada_contable_detalles`
--
...
CREATE TABLE `supervision_realizada_contable_detalles` (
  ...
  KEY `fk_id_supervision_idx` (`id_supervision`),
  KEY `fk_id_criterio_idx` (`id_criterio`),
  CONSTRAINT `fk_id_criterio` FOREIGN KEY (`id_criterio`) REFERENCES `supervision_criterio` (`id_criterio`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_id_supervision` FOREIGN KEY (`id_supervision`) REFERENCES `supervision_realizada` (`id_supervision`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `supervision_realizada_contable_detalles`
--

LOCK TABLES `supervision_realizada_contable_detalles` WRITE;
/*!40000 ALTER TABLE `supervision_realizada_contable_detalles` DISABLE KEYS */;
INSERT INTO `supervision_realizada_contable_detalles` VALUES (40,93,1,'Registra a tiempo'),(40,94,1,''),(40,95,1,''),(40,96,0,''),(40,97,1,''),(40,98,1,''),(40,99,1,''),(40,100,1,''),(40,102,0,''),(40,103,1,''),(40,104,0,'Utiliza un lenguaje poco digerible para los estudiantes'),(40,105,1,''),(40,106,1,''),(40,107,1,''),(40,108,1,''),(40,109,1,''),(40,110,1,''),(40,111,1,''),(40,112,1,''),(40,113,1,''),(40,114,1,''),(40,115,1,''),(40,116,1,''),(40,117,1,''),(40,118,1,''),(40,119,0,''),(40,120,1,''),(40,121,1,''),(40,122,0,''),(40,123,1,''),(40,124,1,''),(41,93,1,''),(41,94,1,''),(41,95,1,''),(41,96,1,''),(41,97,1,''),(41,98,1,''),(41,99,0,''),(41,100,1,''),(41,102,1,''),(41,103,0,''),(41,104,0,''),(41,105,1,''),(41,106,1,''),(41,107,1,''),(41,108,1,''),(41,109,1,''),(41,110,1,''),(41,111,1,''),(41,112,1,''),(41,113,1,''),(41,114,1,''),(41,115,0,''),(41,116,0,''),(41,117,1,''),(41,118,1,''),(41,119,1,''),(41,120,1,''),(41,121,1,''),(41,122,1,''),(41,123,1,''),(41,124,1,''),(42,93,1,''),(42,94,1,''),(42,95,1,''),(42,96,1,''),(42,97,1,''),(42,98,1,''),(42,99,1,''),(42,100,1,''),(42,102,1,''),(42,103,0,''),(42,104,1,''),(42,105,1,''),(42,106,1,''),(42,107,1,''),(42,108,1,''),(42,109,1,''),(42,110,1,''),(42,111,1,''),(42,112,1,''),(42,113,1,''),(42,114,1,''),(42,115,1,''),(42,116,0,''),(42,117,1,''),(42,118,1,''),(42,119,1,''),(42,120,0,''),(42,121,0,''),(42,122,0,''),(42,123,1,''),(42,124,1,''),(45,93,1,''),(45,94,1,''),(45,95,1,''),(45,96,1,''),(45,97,1,''),(45,98,1,''),(45,99,0,''),(45,100,0,''),(45,102,0,''),(45,103,0,''),(45,104,0,''),(45,105,0,''),(45,106,0,''),(45,107,0,''),(45,108,0,''),(45,109,0,''),(45,110,0,''),(45,111,0,''),(45,112,1,''),(45,113,1,''),(45,114,0,''),(45,115,0,''),(45,116,0,''),(45,117,0,''),(45,118,0,''),(45,119,0,''),(45,120,0,''),(45,121,1,''),(45,122,1,''),(45,123,0,''),(45,124,0,'');
/*!40000 ALTER TABLE `supervision_realizada_contable_detalles` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `supervision_realizada_no_contable_detalles`
--
...
CREATE TABLE `supervision_realizada_no_contable_detalles` (
  ...
  `criterio_cumplido` tinyint(4) NOT NULL,
  `comentario` varchar(100) NOT NULL,
  KEY `fk_id_supervision_no_contable_idx` (`id_supervision`),
  KEY `fk_id_criterio_no_contable_idx` (`id_criterio`),
  CONSTRAINT `fk_id_criterio_no_contable` FOREIGN KEY (`id_criterio`) REFERENCES `supervision_criterio_no_contable` (`id_criterio`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_id_supervision_no_contable` FOREIGN KEY (`id_supervision`) REFERENCES `supervision_realizada` (`id_supervision`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table
ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `supervision_rubro_no_contable`
--
...
--
-- Dumping data for table `supervision_rubro_no_contable`
--

LOCK TABLES `supervision_rubro_no_contable` WRITE;
/*!40000 ALTER TABLE `supervision_rubro_no_contable` DISABLE KEYS */;
INSERT INTO `supervision_rubro_no_contable` VALUES (1,'MÉTODOS DE ENSEÑANZA'),(2,'TIPO DE APRENDIZAJE'),(3,'MODO DE TRABAJO'),(4,'ESTRATEGIAS DE ENSEÑANZA EMPLEADAS');
/*!40000 ALTER TABLE `supervision_rubro_no_contable` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `total_horas_materia`
--

DROP TABLE IF EXISTS `total_horas_materia`;
/*!50001 DROP VIEW IF EXISTS `total_horas_materia`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `total_horas_materia` AS SELECT 
 1 AS `id_materia`,
 1 AS `nombre`,
 1 AS `total_horas`*/;
SET character_set_client = @saved_cs_client;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_config_usuario`(
    IN p_id_usuario INT,
    IN p_api_key_gpt VARCHAR(100),
    IN p_api_key_huggingface VARCHAR(100),
    IN p_id_plantel_actual INT,
    IN p_id_carrera_actual INT
)
BEGIN
    DECLARE cnt INT;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `actualizar_docente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_docente`(
    IN p_id_docente INT(11),
    IN p_nombre VARCHAR(45),
    IN p_apellidos VARCHAR(45),
    IN p_correo_electronico VARCHAR(150),
    IN p_perfil_profesional VARCHAR(45)
)
BEGIN
    UPDATE docente 
    SET 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `agendar_supervision` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `agendar_supervision`(
    IN id_horario_nuevo INT,
    IN fecha_nueva DATE
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insertar_coordinador` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertar_coordinador`(
    IN p_tipo_usuario ENUM('Coordinador', 'Administrador'),
    IN p_nombre VARCHAR(60),
    IN p_apellidos VARCHAR(60),
    IN p_correo_electronico VARCHAR(50),
    IN p_contrasenia VARCHAR(500),
    IN p_avatar longtext,
    IN p_carreras_coordina JSON
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insertar_docente_materias_horarios` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertar_docente_materias_horarios`(
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `insertar_supervision` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insertar_supervision`(
    ...
    IN p_conclusion_general TEXT,

    IN p_criterios_contables JSON,

    IN p_criterios_no_contables JSON
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `obtener_supervision_agenda` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `obtener_supervision_agenda`(IN `p_fecha` DATE, IN `p_id_coordinador` INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `recuperar_agenda_por_fecha` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `recuperar_agenda_por_fecha`(
...
--
-- Final view structure for view `consultar_detalles_supervision_realizada`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `lista_carreras_sin_coordinador` AS select `carrera`.`id_carrera` AS `id_carrera`,concat(`carrera`.`tipo`,' ',`carrera`.`nombre`) AS `nombre`,`carrera`.`tipo` AS `tipo` from (`carrera` left join `carrera_coordinador` on(`carrera`.`id_carrera` = `carrera_coordinador`.`id_carrera`)) where `carrera_coordinador`.`id_carrera` is null */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `listar_agenda_supervision`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `listar_criterios_supervision_por_rubro` AS select `r`.`id_rubro` AS `id_rubro`,`r`.`descripcion` AS `rubro_descripcion`,`c`.`id_criterio` AS `id_criterio`,`c`.`descripcion` AS `descripcion_criterio` from (`supervision_rubro` `r` left join `supervision_criterio` `c` on(`r`.`id_rubro` = `c`.`id_rubro`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `listar_criterios_supervision_por_rubro_no_contable`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `total_horas_materia` AS select `m`.`id_materia` AS `id_materia`,`m`.`nombre` AS `nombre`,floor(sum(timestampdiff(MINUTE,`h`.`hora_inicio`,`h`.`hora_fin`)) / 60) AS `total_horas` from (`materia_horarios` `h` join `materia` `m` on(`m`.`id_materia` = `h`.`id_materia`)) group by `m`.`id_materia` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2024-08-23 17:56:20
