...
function ready() {
    crearPeticion("api/CarreraAPI.php", {"case": "recuperar_campos_formulario_listado"}, function (res) {
        ...
        if (rs.grupoPlanteles.length > 0) {
            ...
            construirTarjetasCarreras(rs.listado_detallado);
        } else {
            $("#cardCarrera").empty();
...
function construirTarjetasCarreras(carreras) {
